...
const input = document.querySelector('.input-number-pizza') // input de texto en html
const addTask = document.querySelector('.search-pizza') // form en html
const tasksLists = document.querySelector('.pizzas-lists') // listas renderizadas
